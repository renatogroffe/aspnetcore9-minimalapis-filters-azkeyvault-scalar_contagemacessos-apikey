...
var apiKeyCheckingConfigurations = await ApiKeyCheckingConfigurations.Initialize(builder.Configuration);
builder.Services.AddSingleton(apiKeyCheckingConfigurations);
